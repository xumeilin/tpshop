<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"./template/pc/rainbow/activity\promoteList.html";i:1540260094;s:59:"D:\wamp64\www\tpshop\template\pc\rainbow\public\header.html";i:1547086768;s:59:"D:\wamp64\www\tpshop\template\pc\rainbow\public\footer.html";i:1540260094;s:65:"D:\wamp64\www\tpshop\template\pc\rainbow\public\sidebar_cart.html";i:1540260094;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
							...
							<?php if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?>
								<li>
									<div class="s_xsall">
										...
										<div class="price-tag">
											<span class="now"><em class="li_xfo">￥</em><em><?php echo (isset($goods[price]) && ($goods[price] !== '')?$goods[price]:$goods[shop_price]); ?></em></span>
