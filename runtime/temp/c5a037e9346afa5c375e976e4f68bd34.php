<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/system\shopping.html";i:1540260088;s:62:"D:\wamp64\www\tpshop\application\admin\view\public\layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" enctype="multipart/form-data" name="form1" action="<?php echo U('System/handle'); ?>">
        ...
        <div class="ncap-form-default">
            ...
            <!--<dl class="row">
                ...
                <dd class="opt">
                    <?php if(empty($config[point_rate])): ?>
                    ...
                    <?php else: ?>
                        <input type="radio" name="point_rate" value="<?php echo $config[point_rate]; ?>"  checked >1元 = <?php echo $config[point_rate]; ?>积分
                    <?php endif; ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_confirm_date" id="distribut_date">
                        <?php $__FOR_START_22614__=1;$__FOR_END_22614__=31;for($i=$__FOR_START_22614__;$i < $__FOR_END_22614__;$i+=1){ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <select name="auto_service_date" id="auto_service_date">
                        <?php $__FOR_START_29297__=1;$__FOR_END_29297__=31;for($i=$__FOR_START_29297__;$i < $__FOR_END_29297__;$i+=1){ ?>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="radio" name="reduce" value="1" <?php if($config[reduce] == 1): ?> checked <?php endif; ?>>下单成功时  &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input pattern="^\d{1,}$" name="team_order_limit_time" value="<?php echo (isset($config['team_order_limit_time']) && ($config['team_order_limit_time'] !== '')?$config['team_order_limit_time']:'1800'); ?>" class="input-txt" type="text">
                    <span class="err">%</span>
                    <p class="notic">秒</p>
                </dd>
            </dl>
