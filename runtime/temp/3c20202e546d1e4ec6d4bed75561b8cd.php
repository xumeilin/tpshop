<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/system\push.html";i:1540260088;s:62:"D:\wamp64\www\tpshop\application\admin\view\public\layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/handle'); ?>" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="app_key" name="jpush_app_key" value="<?php echo $config['jpush_app_key']; ?>" class="input-txt" type="text" />
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="master_secret" name="jpush_master_secret" value="<?php echo $config['jpush_master_secret']; ?>" class="input-txt" type="text" />
